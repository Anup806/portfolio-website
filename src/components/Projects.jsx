    ...
    <section className="section" id="projects">
      <div className="container reveal">
        ...
        <div className="projects-grid">
          ...
          <article className="glass-card project-card has-corner-actions">
            <h3 className="project-title">Document Query Engine</h3>
            ...
            <ul className="project-list">
              <li>RAG-based document Q&A with voice chat support</li>
              <li>Groq LLM backend with Google GenAI embeddings</li>
              <li>Fully containerized with Docker, CLI + Web UI</li>
            </ul>
          ...
          <article className="glass-card project-card cyan has-corner-actions">
            ...
            <ul className="project-list">
              <li>Fully offline PDF assistant — no cloud API needed</li>
              <li>Local LLM via Ollama + ChromaDB vector search</li>
              <li>Configurable chunking and semantic retrieval pipeline</li>
            </ul>
          ...
          <article className="glass-card project-card has-corner-actions">
            <h3 className="project-title">Padel Game Analytics</h3>
            ...
            <ul className="project-list">
              <li>Shot classification system (forehand, backhand, serve, smash)</li>
              <li>YOLOv8-based player, ball & racket detection pipeline</li>
              <li>Exports annotated video + timestamped JSON/CSV output</li>
            </ul>
